...
제1조(목적)<br><br>
이 약관은 (주)에스엠케이티앤아이가 운영하는 슈즈마켓 공식 온라인 쇼핑몰(이하“몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하“서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.<br>
...
제2조(정의)<br><br>
  ...
  ① “몰”이란 (주)에스엠케이티앤아이가 재화 또는 용역(이하“재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
  ...
  ⑤‘서비스’라 함은 회사를 통한 구매자와의 물품 매매거래 및 판매자와 구매자간에 물품 매매거래가 이루어 질 수 있는 사이버 거래장소를 온라인으로 제공하는 서비스 및 관련한 부가서비스 일체를 말합니다<br><br>

 

제3조(약관 등의 명시와 설명 및 개정)<br><br>

  ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 슈즈마켓 공식 온라인 쇼핑몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
  ...
  ④ “몰”이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자7일 이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한30일 이상의 사전 유예기간을 두고 공지합니다.  이 경우"몰“은 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.<br>
...
제6조(회원가입)<br><br>
  ...
  ② “몰”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한 회원으로 등록합니다.<br>
    ...
    1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실 후3년이 경과한 자로서“몰”의 회원재가입 승낙을 얻은 경우에는 예외로 한다.<br>
...
제7조(회원 탈퇴 및 자격 상실 등)<br><br>
  ...
  ③ “몰”이 회원 자격을 제한?정지 시킨 후, 동일한 행위가2회 이상 반복되거나30일 이내에 그 사유가 시정되지 아니하는 경우“몰”은 회원자격을 상실시킬 수 있습니다.<br>

  ④ “몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한30일 이상의 기간을 정하여 소명할 기회를 부여합니다.<br><br>
...
제8조(회원에 대한 통지)<br><br>
  ...
  ② “몰”은 불특정다수 회원에 대한 통지의 경우1주일이상“몰” 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.<br><br>
...
제9조(구매신청 및 개인정보 제공 동의 등)<br><br>
  ...
  ① “몰”이용자는“몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.<br>
      ...
      4. 이 약관에 동의하고 위3.호의 사항을 확인하거나 거부하는 표시<br>
  ...
  ② “몰”이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우1) 개인정보를 제공받는 자, 2)개인정보를 제공받는 자의 개인정보 이용목적, 3) 제공하는 개인정보의 항목, 4) 개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.)<br>

  ③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해 알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.<br><br>
...
제11조(지급방법)“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도  추가하여 징수할 수 없습니다.<br><br>
...
제11조-1 (쿠폰/포인트 제도 운영 )<br><br>

  1."몰"은 "이용자"의 재화 구입, 이벤트 참여 등으로 "이용자"에게 "몰"의 혜택 정책에 따라 비광고성 쿠폰/포인트를 지급할 수 있습니다.<br>

  2.해당 정책에 따라 쿠폰/포인트의 지급 및 만료 안내를 알림톡, 문자, 메일 등의 수단으로 안내할 수 있습니다.<br>

  3.혜택은 명시된 유효기간이 지나면 소멸되며, 유효기간이 지난 후에는 사용할 수 없습니다.<br>

  4.쿠폰/포인트의 제공 및 사용 등과 관련한 사항은 이용 약관 또는 "몰"의 운영정책이 정한 바에 따릅니다.<br><br>



제 11조-2 (포인트 이용방법)<br><br>

 ①1포인트는 1원과 동일한 가치를 가지며 1원 이상 적립된 경우 온라인몰에서만 사용할 수 있습니다.<br>

 ②포인트를 사용하여 구매시 최소금액 1천원을 결제하여야 합니다.<br>

 ③ 포인트는 대여,양도의 대상이 되지 않습니다.<br>

 ④ 회원등급별 구매확정에 따른 적립율에 의한 포인트 및 상품후기 (일반,포토후기) 포인트의 유효기간은 발급일로부터 180일,  이벤트(출석체크, 친구추천, 기획전 등)  참여를 통해 획득한 포인트의 유효기간은 발급일로부터 90일입니다. (2020년 8월 1일부터 시행)<br>

예1) 2020년 7월 1일 등급/후기 획득 포인트 소멸 예정일 : 2020년 12월 28일 00시 00분 예2) 2020년 7월 1일 이벤트 참여 획득 포인트 소멸 예정일 : 2020년 9월 29일 00시 00분<br>

 ⑤ 포인트는 유효기간 경과 시 자동소멸되며, 소멸 15일전에 고객에게 문자/메시지 알림등을 통해 소멸안내에 대해 사전 공지합니다.<br>

 ⑥ 포인트는 한 주문건 당 최종 결제 상품금액의 50%까지 사용할 수 있습니다. (2020년 10월 1일부터 시행)<br><br>
...
제13조(재화 등의 공급)<br><br>
  ...
  ① “몰”은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터3영업일 이내에 조치를 취합니다.  이때“몰”은 이용자가 재화 등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한 조치를 합니다.<br>
...
제14조(환급)“몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.<br><br>

 

제15조(청약철회 등)<br><br>

  ① “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 「전자상거래 등에서의 소비자 보호에 관한 법률」 제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터7일 이내에는 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 「전자상거래 등에서의 소비자보호에 관한 법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.<br>

  ② 이용자는 재화 등을 배송 받은 경우 다음 각 호의1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br>
  ...
  ④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날부터3월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터30일 이내에 청약철회 등을 할 수 있습니다.<br><br>

 

제16조(청약철회 등의 효과)<br><br>

  ① “몰”은 이용자로부터 재화 등을 반환받은 경우3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우“몰”이 이용자에게 재화등의 환급을 지연한때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의2에서 정하는지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br>
...
제17조(개인정보보호)<br><br>
  ...
  ①"몰"은 이용자의 정보수집 시 구매계약 이행 및 부가서비스의 제공에 필요한 최소한의 정보를 수집합니다.<br>

다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.<br>

    1. 성명<br>

    2. 본인확인기관에서 제공하는 본인인증결과값(CI)<br>

    3. 주소(배송지와 다른 경우는 배송지 포함)<br>
    ...
    8. 전자우편주소(또는 이동전화번호)<br>

②"몰"이 이용자의 개인식별이 가능한 개인정보를 수집하는 때에는 반드시 당해 이용자의 동의를 받습니다.<br>

③ 제공된 개인정보는 당해 이용자의 동의 없이 수집하거나 목적 외의 이용 또는 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은"몰"이 집니다.<br>
...
④"몰"이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망 이용촉진 및 정보보호등에 관한 법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.<br>
...
⑧ 기타 개인정보의 제공 등 취급과 관련한 내용은 “몰”의 초기 서비스화면(전면)에서 ‘개인정보 취급방침’으로 자세히 고지하며, 이 약관과 별도의 동의를 받습니다.<br><br>
...
제19조(회원의ID 및 비밀번호에 대한 의무)<br><br>

  ① 제17조의 경우를 제외한ID와 비밀번호에 관한 관리책임은 회원에게 있습니다.<br>

  ② 회원은 자신의ID 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다.<br>

  ③ 회원이 자신의ID 및 비밀번호를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로“몰”에 통보하고“몰”의 안내가 있는 경우에는 그에 따라야 합니다.<br><br>

 

제20조(이용자의 의무)이용자는 다음 행위를 하여서는 안 됩니다.<br><br>
...
① 슈머니는 슈즈마켓 온/오프라인 매장(일부매장 제외)에서 슈즈마켓가 지정한 상품 구매시에만 사용이 가능하며, 사용가능금액은 기간에 따라 변경됩니다.<br>   

② 슈머니는 대여나 양도의 대상이 되지 않으며, 현금화는 불가합니다.<br>
따라서 현금이나 물품으로 환불 또는 출금되지 않으며, 반품이나 교환/환불 등으로 발생하는 금액은 슈머니로 재적립됩니다.<br>        

③ 슈머니 사용 중 기계/전산 오류로 인한 재지급 오류에 대해서 회사는 금액적인 책임을 지지 않으며,사용자의 요청에 의해 추후 개별 지급이 가능합니다.<br>          

④ 슈머니 잔액은 매년 12월31일 24시에 자동으로 소멸되며, 매년 1월1일 00시에 새로 다시 지급됩니다.<br>

⑤ 기존 회원의 경우 슈머니가 자동으로 지급되며, 그 사용여부는 회원이 결정합니다.<br>

⑥ 슈머니 1일 사용금액과 수량에 대한 제한은 없으나, 회원이 보유한 슈머니 잔액을 초과할 수 없으며, 슈머니 사용가능 상품별 지정된 할인금액을 초과할 수 없습니다.<br><br>

 

부칙(2022.04.27)<br><br>

1. 이 약관은 2022년 4월27일부터 시행하며 종전의 약관은 이 약관으로 대체합니다.<br>
