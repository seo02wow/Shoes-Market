...
public class ItemBulletinBoardCommand implements Command{
	...
	public String exec(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<ItemVO> list = ItemDAO.getPageList(p.getBegin(), p.getEnd());
		System.out.println(">> 상품 게시글 현재 페이지 글 목록 : " + list);
		req.setAttribute("list", list);
		req.setAttribute("pvo", p);
		
		return "itemBulletinBoard.jsp";
	}
