...
public class ManagerInquiryCommand implements Command {
//231029 박수진
	@Override
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//0. 파라미터 값 전체조회
		System.out.println("ManagerInquiryCommand");
		Paging p = new Paging();
		...
		if (request.getParameter("keyword") != null && request.getParameter("keyword") != "") {
			idx = Integer.parseInt(request.getParameter("keyword"));
		}
		...
		//64. 응답페이지(managerInquiry.jsp)로 위임 처리
						
		return "manager_inquiry.jsp";
	}
